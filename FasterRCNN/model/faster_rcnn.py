...
from model.utils.rpn_function import AnchorsGenerator, RPNHead, RegionProposalNetwork
from model.utils.roi_head import RoIHeads
from torchvision.ops import MultiScaleRoIAlign
from torch.jit.annotations import Tuple, List, Dict, Optional
from torch import Tensor
import torch.nn.functional as F
import warnings
from model.utils.transform import GeneralizedRCNNTransform
...
class FasterRCNNBase(nn.Module):
    ...
    def forward(self, images, targets=None):
        ...
        for img in images:
            ...
            original_image_sizes.append((val[0], val[1])) #宽和高加入
...
class FasterRCNN(FasterRCNNBase):
    ...
    def __init__(self, backbone, num_classes=None,
        ...
        #FasterRCNNBase 父类 FasterRCNN 一个继承FasterRCNNBase的子类
